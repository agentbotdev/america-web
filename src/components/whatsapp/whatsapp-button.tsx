...
// Botón/ enlace a WhatsApp con mensaje precargado. Reutilizable en todos lados:
// cards, ficha, header, flotante. Server-compatible (es un <a>).
...
export function WhatsappButton({
  ...
  const variants = {
    ...
    outline:
      "border border-whatsapp/40 text-whatsapp hover:bg-whatsapp/10 bg-transparent",
  ...
  return (
    ...
    >
      <WhatsappGlyph className={size === "lg" ? "size-5" : "size-4"} />
      {label}
    </a>
  );
}
